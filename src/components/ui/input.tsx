		...
		<>
			<div className='relative'>
				<input
					...
					readOnly={!isEditable}
					className={cn(
						'bg-zinc-100 dark:bg-zinc-800 px-4 py-2 border-[1px] border-b-[3px] border-zinc-300 dark:border-zinc-700 focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-zinc-400 dark:focus-visible:ring-zinc-500 rounded-lg transition-all duration-300 tracking-tight min-w-[400px] text-[#212427] dark:text-white placeholder:text-zinc-400 dark:placeholder:text-zinc-500',
